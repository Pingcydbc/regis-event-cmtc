...
<body class="bg-gradient-to-br from-slate-100 via-stone-50 to-red-50 flex items-center justify-center min-h-screen p-4">
    ...
    <div
        class="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border-t-8 border-red-600 transform transition-all hover:scale-[1.01] relative overflow-hidden">
        ...
        <form id="checkForm" class="space-y-5 relative z-10">
            ...
            <button type="submit"
                class="w-full bg-red-600 hover:bg-red-700 text-white font-medium py-3.5 rounded-xl transition duration-200 shadow-lg shadow-red-200 text-base flex items-center justify-center gap-2">
    ...
    <div id="modal" class="fixed inset-0 bg-black/60 hidden items-center justify-center p-4 backdrop-blur-sm z-50">
        <div
            class="bg-white p-6 rounded-2xl shadow-2xl w-full max-w-md space-y-4 transform transition-all duration-300 border-t-4 border-red-600">
            <h3
                class="text-lg font-bold text-slate-800 border-b pb-2 text-center text-red-600 flex items-center justify-center gap-2">
            ...
            <div class="space-y-1">
                ...
                <p id="modal_student_name"
                    class="text-base font-semibold text-slate-800 bg-slate-50 p-3.5 rounded-xl border border-slate-100">
                    -</p>
            </div>
            ...
            <form id="registerForm" class="space-y-4">
                ...
                <div>
                    <label class="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1">
                        ชื่อ-นามสกุล ผู้ปกครอง (ตรวจสอบ/แก้ไขได้)
                    </label>
                ...
                <div class="flex space-x-3 pt-2">
                    <button type="button" onclick="closeModal()"
                        class="w-1/3 bg-slate-100 hover:bg-slate-200 text-slate-600 font-medium py-3 rounded-xl transition duration-150">
                        ยกเลิก
                    </button>
                    <button type="submit"
                        class="w-2/3 bg-red-600 hover:bg-red-700 text-white font-medium py-3 rounded-xl transition duration-150 shadow-lg shadow-red-100">
                        ยืนยันการลงทะเบียน
                    </button>
                </div>
            </form>
    ...
    <script>
        ...
        // ขั้นตอนที่ 1: ตรวจเช็กข้อมูลเลขรหัส
        ...
        // ขั้นตอนที่ 2: กดบันทึกข้อมูลการลงทะเบียน
        document.getElementById('registerForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                Swal.fire({
                    ...
                    text: 'ระบบขัดข้อง ไม่สามารถบันทึกข้อมูลได้',
                    confirmButtonColor: '#dc2626',
                    customClass: { popup: 'rounded-2xl' }
                });
            }
